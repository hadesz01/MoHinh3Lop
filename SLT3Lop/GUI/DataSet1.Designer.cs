...
namespace GUI {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class SinhVienDataTable : global::System.Data.TypedTableBase<SinhVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public SinhVienRow AddSinhVienRow(string MaSV, string TenSV, string MaLop) {
...
namespace GUI.DataSet1TableAdapters {
    ...
    public partial class SinhVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[SinhVien] WHERE (([MaSV] = @Original_MaSV) AND ((@IsNull_TenSV" +
                " = 1 AND [TenSV] IS NULL) OR ([TenSV] = @Original_TenSV)) AND ((@IsNull_MaLop = " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[SinhVien] ([MaSV], [TenSV], [MaLop]) VALUES (@MaSV, @TenSV, @M" +
                "aLop);\r\nSELECT MaSV, TenSV, MaLop FROM SinhVien WHERE (MaSV = @MaSV)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[SinhVien] SET [MaSV] = @MaSV, [TenSV] = @TenSV, [MaLop] = @MaLop WHERE (([MaSV] = @Original_MaSV) AND ((@IsNull_TenSV = 1 AND [TenSV] IS NULL) OR ([TenSV] = @Original_TenSV)) AND ((@IsNull_MaLop = 1 AND [MaLop] IS NULL) OR ([MaLop] = @Original_MaLop)));
SELECT MaSV, TenSV, MaLop FROM SinhVien WHERE (MaSV = @MaSV)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GUI.Properties.Settings.Default.QLHSConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaSV, TenSV, MaLop FROM dbo.SinhVien";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        TOP (1) CAST(RIGHT(MaSV, 3) + 1 AS integer) AS SV\r\nFROM            " +
                "SinhVien\r\nORDER BY MaSV DESC";
        ...
        public virtual int getMaSV(DataSet1.SinhVienDataTable dataTable) {
        ...
        public virtual DataSet1.SinhVienDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            DataSet1.SinhVienDataTable dataTable = new DataSet1.SinhVienDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        public virtual int Delete(string Original_MaSV, string Original_TenSV, string Original_MaLop) {
        ...
        public virtual int Insert(string MaSV, string TenSV, string MaLop) {
            if ((MaSV == null)) {
        ...
        public virtual int Update(string MaSV, string TenSV, string MaLop, string Original_MaSV, string Original_TenSV, string Original_MaLop) {
            if ((MaSV == null)) {
                throw new global::System.ArgumentNullException("MaSV");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TenSV, string MaLop, string Original_MaSV, string Original_TenSV, string Original_MaLop) {
            return this.Update(Original_MaSV, TenSV, MaLop, Original_MaSV, Original_TenSV, Original_MaLop);
        }
    }
